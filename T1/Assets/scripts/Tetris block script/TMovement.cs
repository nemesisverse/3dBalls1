    ...
    void verticalflagRadius(int i)
{
             ...
             Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.up, Vector3.up)) < 0.99f)
    {
        ...
        // First block at [i-1]
        if (gameManager.plusYDimension[i - 1] == null) 
            gameManager.plusYDimension[i - 1] = verticalChildObject[0];
        ...
        // Second block at [i-2]
        if (gameManager.plusYDimension[i - 2] == null) 
            gameManager.plusYDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.plusZDimension[i - 2] == null) 
            gameManager.plusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.minusYDimension[i - 2] == null) 
            gameManager.minusYDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.minusZDimension[i - 2] == null) 
            gameManager.minusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.plusYplusZDimension[i - 2] == null) 
            gameManager.plusYplusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.plusYminusZDimension[i - 2] == null) 
            gameManager.plusYminusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.minusYplusZDimension[i - 2] == null) 
            gameManager.minusYplusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.minusYminusZDimension[i - 2] == null) 
             ...
             Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.right, Vector3.right)) < 0.99f)
    {
        ...
        if (gameManager.plusXDimension[i - 2] == null) 
            ...
            gameManager.minusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.minusXminusZDimension[i - 2] == null) 
            gameManager.minusXminusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.minusXplusZDimension[i - 2] == null) 
            gameManager.minusXplusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.plusXminusZDimension[i - 2] == null) 
            gameManager.plusXminusZDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.plusXplusZDimension[i - 2] == null) 
            gameManager.plusXplusZDimension[i - 2] = verticalChildObject[1];
    }

    // XY parallel to global XY and XZ parallel to global YZ
    else if ((Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.forward, globalNormalZ)) > 0.99f) && 
             (Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.up, globalNormalX)) > 0.99f))
    {
        Debug.Log("XY is parallel to global XY and XZ is parallel to global YZ");
        
        // XY ring - First block at [i-1]
        if (gameManager.plusXDimension[i - 1] == null) 
            gameManager.plusXDimension[i - 1] = verticalChildObject[0];
        else if (gameManager.plusYDimension[i - 1] == null) 
            gameManager.plusYDimension[i - 1] = verticalChildObject[0];
    ...
    // XY parallel to global XY and YZ parallel to global YZ
    else if ((Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.forward, globalNormalZ)) > 0.99f) && 
             (Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.right, globalNormalX)) > 0.99f))
    {
        Debug.Log("XY is parallel to global XY and YZ is parallel to global YZ");
    ...
    // YZ parallel to global XY and XY parallel to global YZ
    else if ((Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.right, globalNormalZ)) > 0.99f) && 
             (Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.forward, globalNormalX)) > 0.99f))
    {
        Debug.Log("YZ is parallel to global XY and XY is parallel to global YZ");
    ...
    // YZ parallel to global XY and XZ parallel to global YZ
    else if ((Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.right, globalNormalZ)) > 0.99f) && 
             (Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.up, globalNormalX)) > 0.99f))
    {
        ...
        if (gameManager.plusYDimension[i - 1] == null) 
            ...
            gameManager.minusYminusZDimension[i - 1] = verticalChildObject[0];
        // XZ ring - First block at [i-1]
        else if (gameManager.plusXDimension[i - 1] == null) 
            gameManager.plusXDimension[i - 1] = verticalChildObject[0];
        else if (gameManager.minusXDimension[i - 1] == null) 
            gameManager.minusXDimension[i - 1] = verticalChildObject[0];
        else if (gameManager.minusXminusZDimension[i - 1] == null) 
        ...
        if (gameManager.plusYDimension[i - 2] == null) 
            ...
            gameManager.minusYminusZDimension[i - 2] = verticalChildObject[1];
        // XZ ring - Second block at [i-2]
        else if (gameManager.plusXDimension[i - 2] == null) 
            gameManager.plusXDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.minusXDimension[i - 2] == null) 
            gameManager.minusXDimension[i - 2] = verticalChildObject[1];
        else if (gameManager.minusXminusZDimension[i - 2] == null) 
    ...
    // XZ parallel to global XY and XY parallel to global YZ
    else if ((Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.up, globalNormalZ)) > 0.99f) && 
             (Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.forward, globalNormalX)) > 0.99f))
    {
        Debug.Log("XZ is parallel to global XY and XY is parallel to global YZ");
    ...
    // XZ parallel to global XY and YZ parallel to global YZ
    else if ((Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.up, globalNormalZ)) > 0.99f) && 
             (Mathf.Abs(Vector3.Dot(gameManager.motherPlatform.transform.right, globalNormalX)) > 0.99f))
    {
